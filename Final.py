...
count0hist = round(count0/totalcount,2)
count1hist = round(count1/totalcount,2)
count2hist = round(count2/totalcount,2)
count3hist = round(count3/totalcount,2)
count4hist = round(count4/totalcount,2)
count5hist = round(count5/totalcount,2)
count6hist = round(count6/totalcount,2)
count7hist = round(count7/totalcount,2)
count8hist = round(count8/totalcount,2)
